...
<div class="col-lg-6 col-xl-7">
    <div class="card">
        ...
        <div class="d-flex align-items-center">
            <h2 class="card-title mnb-6 mr-auto">Result</h2><a href="{{ route('singleExport.get', ['slug' => session('validate.next')['id']]) }}" class="btn btn-brand btn-uniform btn-round btn-sm mnt-8 mnb-8" target="_blank"><span  data-feather="download" class="rui-icon rui-icon-stroke-1_5"></span>DOWNLOAD REPORT</a>
        </div>
