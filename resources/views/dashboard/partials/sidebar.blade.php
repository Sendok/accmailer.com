<div class="yay-wrap-menu">
  <div class="yaybar-wrap">
    <ul>
      ...
      <li class="yay-item-active"><a href="single"><span class="yay-icon"><span data-feather="mail" class="rui-icon rui-icon-stroke-1_5"></span></span><span>Single Verification</span><span class="rui-yaybar-circle"></span></a></li>
      <li class="yay-label">Bulk Email Verification</li>
      <li><a href="bulk"><span class="yay-icon"><span data-feather="layers" class="rui-icon rui-icon-stroke-1_5"></span></span><span>Bulk Verification</span><span class="rui-yaybar-circle"></span></a></li>
      <li class="yay-label">API Email Verification</li>
      <li><a href="api"><span class="yay-icon"><span data-feather="box" class="rui-icon rui-icon-stroke-1_5"></span></span><span>API Verification</span><span class="rui-yaybar-circle"></span></a></li>
